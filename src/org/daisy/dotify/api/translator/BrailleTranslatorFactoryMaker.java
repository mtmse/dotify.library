...
public class BrailleTranslatorFactoryMaker implements BrailleTranslatorFactoryMakerService {
    ...
    public static BrailleTranslatorFactoryMaker newInstance() {
        ...
        {
            Iterator<BrailleTranslatorFactoryService> i =
                ServiceLoader.load(BrailleTranslatorFactoryService.class).iterator();
            while (i.hasNext()) {
    ...
    public BrailleTranslatorFactory newFactory(String locale, String grade) throws TranslatorConfigurationException {
        ...
        if (template == null) {
            throw new BrailleTranslatorFactoryMakerConfigurationException(
                "Cannot locate a factory for " + toKey(locale, grade)
            );
        }
