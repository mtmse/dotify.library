...
public class BrailleFilterFactoryMaker implements BrailleFilterFactoryMakerService {
    ...
    public static BrailleFilterFactoryMaker newInstance() {
        ...
        {
            Iterator<BrailleFilterFactoryService> i =
                ServiceLoader.load(BrailleFilterFactoryService.class).iterator();
            while (i.hasNext()) {
    ...
    public BrailleFilterFactory newFactory(String locale, String grade) throws TranslatorConfigurationException {
        ...
        if (template == null) {
            throw new BrailleFilterFactoryMakerConfigurationException(
