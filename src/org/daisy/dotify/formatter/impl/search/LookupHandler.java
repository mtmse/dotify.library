...
class LookupHandler<K, V> {
    ...
    /**
     * Keeps a value for later commit. Unlike {@link #put(Object, Object)}, multiple calls to keep for the same
     * key will not affect the status of the LookupHandler. Upon calling commit, the final value for each key are put
