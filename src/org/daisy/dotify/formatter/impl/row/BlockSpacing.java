...
class BlockSpacing {
    ...
    BlockSpacing(BlockMargin margins, RowDataProperties rdp, int flowWidth, char spaceCharacter) {
        this.collapsiblePreContentRows = makeCollapsiblePreContentRows(
            rdp,
            margins.getLeftParent(),
            margins.getRightParent()
        );
        ...
        MarginProperties margin = new MarginProperties(
    ...
    private static List<RowImpl> makeCollapsiblePreContentRows(
        RowDataProperties rdp,
        MarginProperties leftParent,
        MarginProperties rightParent
    ) {
    ...
    private static List<RowImpl> makeInnerPreContentRows(
        char spaceCharacter,
        RowDataProperties rdp,
        int flowWidth,
        BlockMargin margins
    ...
    private static RowImpl makeDecorationRow(
        RowDataProperties rdp,
        int flowWidth,
        SingleLineDecoration d,
        MarginProperties leftParent,
        MarginProperties rightParent
    ) {
