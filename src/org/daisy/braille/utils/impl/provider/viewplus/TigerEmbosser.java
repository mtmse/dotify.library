...
public class TigerEmbosser extends AbstractEmbosser {
    ...
    private static final String table6dot =
            "org.daisy.braille.impl.table.DefaultTableProvider.TableType.EN_US";
    //private static final String table8dot =
    //      "com_viewplusViewPlusTableProvider.TableType.TIGER_INLINE_SUBSTITUTION_8DOT";
    ...
    private byte[] getHeader(boolean duplex,
        ...
        header.append((char) 0x1b);
        header.append("AA");                             // US Braille table
