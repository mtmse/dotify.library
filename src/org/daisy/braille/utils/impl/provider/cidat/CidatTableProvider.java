...
public class CidatTableProvider implements TableProvider {
    ...
    public CidatTableProvider() {
        ...
        //tables.add(
        //    new EmbosserTable(
        //        "Transparent mode (8 dot)",
        //        "Portathiel 8-dot in transparent mode",
        //        TableType.PORTATHIEL_TRANSPARENT_8DOT,
        //        this
        //    )
        //);
    }
        ...
        switch ((TableType) fp) {
            case IMPACTO_TRANSPARENT_6DOT:
                return new EmbosserTable(
                    TableType.IMPACTO_TRANSPARENT_6DOT,
            ...
            case IMPACTO_TRANSPARENT_8DOT:
                return new EmbosserTable(
                    TableType.IMPACTO_TRANSPARENT_8DOT,
                    EightDotFallbackMethod.values()[0],
                    '\u2800'
                ) {
            ...
            case PORTATHIEL_TRANSPARENT_6DOT:
                return new EmbosserTable(
                    TableType.PORTATHIEL_TRANSPARENT_6DOT,
                    EightDotFallbackMethod.values()[0],
                    '\u2800'
                ) {
