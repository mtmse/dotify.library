 ...
 */
public class SimpleHyphenatorSETest {
    private HyphenatorInterface hyphenator;

    @Before
    public void before() {
        try {
            hyphenator = new SimpleHyphenatorFactory().newHyphenator("sv");
    ...
    public void testCLITestCase() {
        ...
        assertEquals(
            "⠠⠤istäl\u00ADlet för att be\u00ADrät\u00ADta en his\u00ADto\u00ADria or\u00ADdent\u00ADligt, som man " +
            "ska, kom\u00ADmer han med med la\u00ADby\u00ADrin\u00ADter och trå\u00ADdar och ari\u00ADad\u00ADnor⠱ " +
            "(som in\u00ADte är ari\u00ADad\u00ADnor)",
            hyph(
        ...
        assertEquals(
            ...
            "en bok.",
            hyph(
                "⠠⠤och man förstår inte vad sjutton han håller på med⠱. jag försvarar mig (jag måste försvara min " +
