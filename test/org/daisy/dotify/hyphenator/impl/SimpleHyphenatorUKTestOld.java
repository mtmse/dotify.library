...
/**
 * This class tests the old Latex hyphenator to verify the new SimpleHyphenator.
 */
public class SimpleHyphenatorUKTestOld {
    private HyphenatorInterface hyphenator;

    @Before
    public void before() {
        try {
            hyphenator = new LatexHyphenatorFactory(LatexHyphenatorCore.getInstance()).newHyphenator("en");
